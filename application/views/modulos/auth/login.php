...
<html>
    <head>
        ...
        <!-- Title -->
        <title>Gestor | Login - Sign in</title>
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="index.html" class="logo-name text-lg text-center">App Questões</a>
                                ...
                                <form class="m-t-md" action="<?php echo current_url(); ?>" method="post">
                                    ...
                                    <button type="submit" name="enviar" class="btn btn-success btn-block">Login</button>
                                    <!-- 
                                ...
                                <p class="text-center m-t-xs text-sm"><?php echo date("Y")?> &copy; Clipdata.</p>
                            </div>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
