						...
						<div class="col-md-8" data-container="main">
							<div class="panel panel-default">
								<div class="panel-heading clearfix">
				                    <h4 class="panel-title">Clientes / Remover</h4>
								...
								<div class="panel-body" style="margin-top:10px;">
									...
									<form id="form_usuario" class="form-horizontal" method="post">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" disabled="" value="<?php echo set_value("id", $item->id); ?>" class="form-control" name="id" id="id">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" disabled="" value="<?php echo set_value("nome_empresa", $item->nome_empresa); ?>" class="form-control" name="nome_empresa" id="nome_empresa">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" disabled="" value="<?php echo set_value("email", $item->email); ?>" class="form-control" name="email" id="email">
											</div>
										</div>
