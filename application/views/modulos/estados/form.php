	...
	<div class="span8" data-container="main">
		<div class="widget">
			...
			<div class="widget-content">
				...
				<form id="form_estados" class="form-horizontal" method="post" action="<?php echo current_url(); ?>">
					<fieldset>
...
<input name="id" type="hidden" id="id" value="<?php echo set_value("id", @$item->id) ?>" />
			...
			<script type="text/javascript" src="<?php echo base_url(); ?>assets/modulos/estados/validate.js"></script>
		</div>
		<!-- /widget -->
	</div>
</div>