<div class="page-breadcrumb">
    <ol class="breadcrumb container">
        ...
        <li><a href="<?php echo site_url("formacoes")?>">Formacoes</a></li>
        <li>Adicionar Formacoe </li>
    </ol>
</div>
<div class="page-title">
    <div class="container">
        <h3>Controle de Formacoes</h3>
    </div>
</div>
						...
						<div class="col-md-8" data-container="main">
							<div class="panel panel-default">
								<div class="panel-heading clearfix">
				                    <h4 class="panel-title">Formacoes / <?php echo (@$item->id) ? "Editar" : "Adicionar"?> </h4>
								...
								<div class="panel-body" style="margin-top:10px;">
									...
									<form id="form_formacoes" action="<?php echo current_url(); ?>" class="form-horizontal" method="post">
